<?php
	...
	*/
	...
	$email_to = "tomomatt9591@gmail.com"; 			// Specify the email address you want to send the mail to.
	$email_subject = "I would like to join your mailing list"; 	// Set the subject of your email.
	// Specify a page on your website to display a thankyou message when the mail is sent
	$thankyou_url = "https://tourneygamers.com/home.html";
